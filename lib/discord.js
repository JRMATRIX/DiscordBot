...
//        this.Client.channels.find( ch => ch.name === channelName ).then( channel => {
//            return channel;
//        }).catch( console.error );
...
/*========================================================================*/
    ...
    mixerEmbed( data ) {
        ...
        if( data.announcementMessage ) this.deletePreviousEmbed( data.announcementMessage, channel );
        
        if( channel )
           return channel.send( embed ).then( message => { return message; }).catch( console.error );
    }
    ...
    endMixerEmbed( data ) {
        ...
        return message.edit( embed ).then( message => { return message; }).catch( console.error );
    }
    ...
    listMixerEmbed( channels ) {
        ...
        return this.msg.channel.send( embed ).then ( message => { return message; }).catch( console.error );
    }
