...
/*========================================================================*/
    ...
    addMixerChannel( mixerChannel, announcementChannel ) {
        ...
        return new Promise( function( resolve, reject ) {
            if( ! exists ) {
                ...
                reject({
                    error : 'Mixer Channel Exists',
                    message : `The Mixer Channel for ${mixerChannel.token} has already been added` });
            }
        }).catch( console.error );
    }
        ...
        return new Promise( function( resolve, reject ) {
            if( exists ) {
                ...
                reject({
                    ...
                    message : `The Mixer Channel for ${mixerChannel.token} doesn't exists in the Database` });
            }
        }).catch( console.error );
    }
        ...
        return new Promise( function( resolve, reject ) {
            if( exists ) {
                ...
                reject({
                    ...
                    message : `The Mixer Channel for ${mixerChannel.token} is not in the bot announcement list. It may have already been removed`
                });
            }
        }).catch( err => {
            console.error( err );
    ...
    getMixerAnnouncementChannel() {
        ...
        if( mixerAnnouncementChannel && mixerAnnouncementChanne !== undefined )
            return mixerAnnouncementChannel.substring(1);
        
        if( defaultAnnouncementChannel && defaultAnnouncementChannel !== undefined )
            return defaultAnnouncementChannel.substring(1);
...
/*========================================================================*/
    ...
    hasOption( option ) {
        return new Promise( function( resolve, reject ) {
            ...
            reject({
                title : 'Unknown Error',
                content : `Something went wrong trying to check the Database for ${option}` });
        });
    }
    ...
    getOption( option ) {
        return new Promise( function( resolve, reject ) {
            ...
            reject({
                title : 'Unknown Error',
                content : `Something went wrong trying to retrieve ${option} from the Database` });
        });
    }
    ...
    setOption( option, value ) {
        return new Promise( function( resolve, reject ) {
            ...
            reject({
                title : 'Unknown Error',
                content : `Something went wrong trying to set ${option} to ${value} in the Database` });
        });
    }
    ...
    getDefaultAnnouncementChannel() {
        this.getOption( 'defaultAnnouncementChannel' );
    }
